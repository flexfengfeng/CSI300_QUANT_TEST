#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""从腾讯财经接口下载中证500 (sh000905) 指数日线, 覆盖 2007-01 ~ 2026-08。

接口语义: `symbol,day,,{end},{count},qfq` 返回 end 之前最近 count 条。
用连续翻页: 每次取 800 条, 下轮 end = 已取首条日期 - 1 天, 直到覆盖 2007 年。
输出: daily_CN_000905.csv (time_key, open, high, low, close, volume)
"""
import os
import time
import requests
...
SYMBOL = "sh000905"
OUT = os.path.join(BASE, "daily_CN_000905.csv")
