...
OUT = os.path.join(BASE, "csi500_pe_ttm.csv")
LOG = os.path.join(BASE, "fetch_pe_csi500.log")
...
def main():
    try:
        ...
        params = {"token": token, "indexCode": "000905.SH"}
